...
export class SqliteStorage implements StorageAdapter {
  ...
  async queryTraceIds(
    ...
    const recordedSummary = sql<string>`COALESCE(json_extract(${spans.metadata}, '$."pulse.metadata.summary"'), json_extract(${spans.metadata}, '$."pulse.summary"'), json_extract(${spans.metadata}, '$.summary'))`;
